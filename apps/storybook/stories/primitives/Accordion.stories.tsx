...
import {
  ...
  AccordionTrigger,
  AccordionContent,
} from "@workspace/ui/primitives/accordion";
...
export const MultipleOpen: Story = {
  render: () => (
    <Accordion type="multiple" className="w-[400px]">
      ...
      <AccordionItem value="item-3">
        <AccordionTrigger>Can I control it?</AccordionTrigger>
        <AccordionContent>
          Yes. You can use the value and onValueChange props for controlled
          behavior.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
